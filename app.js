...
function get_weather_v1(request, response) {
    // if(request.headers.authorization == "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlBhdmFuIiwiaWF0IjoxNTE2MjM5MDIyfQ.x4WyTjDgssFcm71b_nyx5FAB9HwSSFwOQrX6hGMbeg8")
...
function get_hello(req,res){
    ...
    // if(req.headers.authorization == "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlBhdmFuIiwiaWF0IjoxNTE2MjM5MDIyfQ.x4WyTjDgssFcm71b_nyx5FAB9HwSSFwOQrX6hGMbeg8")
...
function post_auth(req,res){
    ...
    if(usernames.includes(username)){
      if(passwords.includes(pwd)){
          res.json({
            "access-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlBhdmFuIiwiaWF0IjoxNTE2MjM5MDIyfQ.x4WyTjDgssFcm71b_nyx5FAB9HwSSFwOQrX6hGMbeg8",
            "expires": new Date()
          })
      }
  }
